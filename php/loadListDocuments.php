...
if (strcmp($identify_tab, "tab1") == 0) { //CHAIR
    $test = "";
    $i = 0;
    $stringFinalData = "<div class=\"container\"><div class=\"panel-group\" id=\"accordion\">";
    foreach ($dataEvents as $field) { // controllo se in entrambi i json risulta già l'email in input 
        foreach ($field as $field2 => $value2) {
            $stringFinalData .= "<div class=\"panel panel-default\"><div class=\"panel-heading\"><h4 class=\"panel-title\"><a data-toggle=\"collapse\" data-parent=\"#accordion\" href=\"#tab1" . $i . "\"  >" . $value2["conference"] . "</a></h4></div><div id=\"tab1" . $i . "\" class=\"panel-collapse collapse\">";
    ...
    foreach ($dataEvents as $field) { // controllo se in entrambi i json risulta già l'email in input 
        foreach ($field as $field2 => $value2) {
            $stringFinalData .= "<div class=\"panel panel-default\"><div class=\"panel-heading\"><h4 class=\"panel-title\"><a data-toggle=\"collapse\" data-parent=\"#accordion\" href=\"#tab2" . $i . "\"  >" . $value2["conference"] . "</a></h4></div><div id=\"tab2" . $i . "\" class=\"panel-collapse collapse\">";
    ...
    foreach ($dataEvents as $field) { // controllo se in entrambi i json risulta già l'email in input 
        foreach ($field as $field2 => $value2) {
            $stringFinalData .= "<div class=\"panel panel-default\"><div class=\"panel-heading\"><h4 class=\"panel-title\"><a data-toggle=\"collapse\" data-parent=\"#accordion\" href=\"#tab3" . $i . "\"  >" . $value2["conference"] . "</a></h4></div><div id=\"tab3" . $i . "\" class=\"panel-collapse collapse\">";
